...
ALevelTransitionVolume::ALevelTransitionVolume()
{
	...
	Billbord = CreateDefaultSubobject<UBillboardComponent>(TEXT("Billbord"));
	Billbord->SetupAttachment(GetRootComponent());

	NextLevel = FName("SunTemple");
